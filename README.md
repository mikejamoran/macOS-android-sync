...
> **Note:** This project was developed with the assistance of **Gemini CLI**. This may be a no-go for some users, and that's absolutely fine. AI, or more specifically generative AI, is bad for the vast majority of uses and should never be used to generate creative pursuits such as artwork, music or writing. This app has utilised it in development assistance for something I've not been happy with in existing apps. However, this is still an example of using AI in coding so please bear this in mind before you use it -- I am uploading this in case it is of interest, but I appreciate fully that AI is a red line for many people. 
